...
export const recoveryHeroCopy: Record<Language, RecoveryHeroCopy> = {
  en: {
    ...
    description: 'Understand what happened. Follow the transaction trail. BrightFund Recovery brings case information, blockchain analysis, and recovery guidance into one structured process.',
  ...
  fr: {
    ...
    description: 'Comprenez les faits. Suivez les transactions. BrightFund Recovery réunit les informations du dossier, l’analyse blockchain et les pistes de recouvrement dans une démarche structurée.',
  ...
  de: {
    ...
    description: 'Verstehen Sie die Ereignisse. Verfolgen Sie die Transaktionen. BrightFund Recovery verbindet Fallinformationen, Blockchain-Analyse und mögliche Rückgewinnungsschritte in einem strukturierten Prozess.',
  ...
  it: {
    ...
    description: 'Comprendi i fatti. Segui le transazioni. BrightFund Recovery riunisce informazioni sul caso, analisi blockchain e orientamento al recupero in un percorso strutturato.',
