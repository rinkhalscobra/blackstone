...
const cases = [
  { from: "Binance", subject: "Exchange scam · BTC", preview: "Trace complete on 3 wallets. Freeze requested via VASP…", time: "9:41 AM", unread: true, active: true, amount: "€48,200" },
  { from: "Sophia Chen", subject: "Phishing wallet · ETH", preview: "Attacker moved funds through Tornado mixer. New leads…", time: "8:12 AM", unread: true, amount: "€12,480" },
  { from: "Fake ICO Case", subject: "Rug pull — Nova token", preview: "Legal filing prepared for jurisdiction transfer.", time: "Yesterday", amount: "€8,900" },
  { from: "Marcus L.", subject: "Romance scam · USDT", preview: "Victim statement collected. Awaiting chain trace review.", time: "Yesterday", amount: "€22,100" },
  { from: "Chainalysis", subject: "Wallet cluster report", preview: "6 addresses tagged as high-risk mixer output.", time: "Mon", amount: "€6,300" },
  { from: "David Lim", subject: "Impersonation · SOL", preview: "Exchange KYC pull confirms recipient identity.", time: "Mon", amount: "€3,750" },
];

const labels = [
  { name: "BTC", color: "#fbbf24" },
  { name: "ETH", color: "#3b82f6" },
  { name: "USDT", color: "#10b981" },
  { name: "SOL", color: "#8b5cf6" },
];
...
const AppMockup = () => (
  <motion.div
    ...
    className="max-w-6xl mx-auto px-6 py-16 md:py-24 relative z-10"
  >
    <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-[#0e1014]/90 backdrop-blur-2xl shadow-[0_40px_120px_-20px_rgba(59,130,246,0.35)]">
      {/* Title bar */}
      ...
      <div className="grid grid-cols-12 h-[520px]">
            ...
            {cases.map((c, i) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  {c.unread && <span className="w-1.5 h-1.5 rounded-full bg-[#3b82f6]" />}
                ...
                <div className="flex items-center justify-between gap-2 mb-0.5">
                  ...
                  <span className="text-[10px] font-semibold text-[#fbbf24]">{c.amount}</span>
                </div>
        ...
        <div className="col-span-5 flex flex-col">
          ...
          <div className="flex-1 overflow-hidden p-5">
            <h3 className="text-base font-semibold text-white mb-3">Binance exchange scam · BTC recovery</h3>
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#3b82f6] to-[#fbbf24] flex items-center justify-center text-[11px] font-bold text-white">
                R
              </div>
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#fbbf24]/15 text-[#fbbf24] border border-[#fbbf24]/25 font-medium">
                Phase 3 · Legal
              </span>
            </div>
            ...
            <div className="space-y-2 text-[11px] text-white/70 leading-relaxed">
              <p>Hi Alexander,</p>
              <p>
                We finalized the chain-of-custody report on the 1.42 BTC transferred out of your Binance account on May 3.
