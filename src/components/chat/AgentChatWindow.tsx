    ...
    return (
      ...
      >
        <img 
          ...
          className="max-w-[180px] max-h-[180px] rounded-lg object-cover border border-border/50"
        />
      </a>
    );
  }
...
export const AgentChatWindow = ({
  ...
  const { messages, isLoading, isUploading, uploadProgress, overallProgress, sendMessage, uploadAttachments, getSignedUrl } = useMessages(conversationId, customerId);
  ...
  return (
    <Card className={cn("flex flex-col h-[400px]", className)}>
        ...
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center py-8">
            ...
            <p className="text-sm text-muted-foreground">
              No messages yet. Start a conversation with {customerName}.
            </p>
          </div>
        ) : (
          <div className="space-y-3">
      ...
      <CardContent className="border-t border-border p-3 flex-shrink-0 space-y-2">
        {/* Upload progress */}
